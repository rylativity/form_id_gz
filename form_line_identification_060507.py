...
def process_I9_06_05_07(page):  
 ...
 "    
    info_dict["Iss. Authority (A)"] = pytesseract.image_to_string(page1[address_top_line+int(vertical_standard_scaler*10.57143):address_top_line+int(vertical_standard_scaler*11.06723),left_form_edge+int(horizontal_standard_scaler*-1.47689):left_form_edge+int(horizontal_standard_scaler*-0.61738)])
    info_dict["Iss. Authority (B)"] = pytesseract.image_to_string(page1[address_top_line+int(vertical_standard_scaler*10.57143):address_top_line+int(vertical_standard_scaler*11.06723),left_form_edge+int(horizontal_standard_scaler*-0.39926):left_form_edge+int(horizontal_standard_scaler*0.68207)])
    info_dict["Iss. Authority (C)"] = pytesseract.image_to_string(page1[address_top_line+int(vertical_standard_scaler*10.57143):address_top_line+int(vertical_standard_scaler*11.06723),left_form_edge+int(horizontal_standard_scaler*1.10721):left_form_edge+int(horizontal_standard_scaler*2.18854)])
     
    info_dict["Doc. # (A)"] = pytesseract.image_to_string(page1[address_top_line+int(vertical_standard_scaler*11.11765):address_top_line+int(vertical_standard_scaler*11.59664),left_form_edge+int(horizontal_standard_scaler*-1.59519):left_form_edge+int(horizontal_standard_scaler*-0.61738)])
    info_dict["Doc. # (B)"] = pytesseract.image_to_string(page1[address_top_line+int(vertical_standard_scaler*11.11765):address_top_line+int(vertical_standard_scaler*11.59664),left_form_edge+int(horizontal_standard_scaler*-0.39926):left_form_edge+int(horizontal_standard_scaler*0.68207)])
    info_dict["Doc. # (C)"] = pytesseract.image_to_string(page1[address_top_line+int(vertical_standard_scaler*11.11765):address_top_line+int(vertical_standard_scaler*11.59664),left_form_edge+int(horizontal_standard_scaler*1.10721):left_form_edge+int(horizontal_standard_scaler*2.18854)])
    
    info_dict["Doc. Expir. (A)"] = pytesseract.image_to_string(page1[address_top_line+int(vertical_standard_scaler*11.64706):address_top_line+int(vertical_standard_scaler*12.13445),left_form_edge+int(horizontal_standard_scaler*-1.15896):left_form_edge+int(horizontal_standard_scaler*-0.61553)])
    info_dict["Doc. Expir. (B)"] = pytesseract.image_to_string(page1[address_top_line+int(vertical_standard_scaler*11.64706):address_top_line+int(vertical_standard_scaler*12.13445),left_form_edge+int(horizontal_standard_scaler*-0.39926):left_form_edge+int(horizontal_standard_scaler*0.68207)])
    info_dict["Doc. Expir. (C)"] = pytesseract.image_to_string(page1[address_top_line+int(vertical_standard_scaler*11.64706):address_top_line+int(vertical_standard_scaler*12.13445),left_form_edge+int(horizontal_standard_scaler*1.10721):left_form_edge+int(horizontal_standard_scaler*2.18854)])
    
    info_dict["Employ. Start Date"] = pytesseract.image_to_string(page1[address_top_line+int(vertical_standard_scaler*13.94958):address_top_line+int(vertical_standard_scaler*14.41176),left_form_edge+int(horizontal_standard_scaler*-1.47505):left_form_edge+int(horizontal_standard_scaler*-0.96488)])
    info_dict["Verifier Name"] = pytesseract.image_to_string(page1[address_top_line+int(vertical_standard_scaler*15.15126):address_top_line+int(vertical_standard_scaler*15.81513),left_form_edge+int(horizontal_standard_scaler*-0.38632):left_form_edge+int(horizontal_standard_scaler*1.03882)])
    info_dict["Verifier Title"] = pytesseract.image_to_string(page1[address_top_line+int(vertical_standard_scaler*15.15126):address_top_line+int(vertical_standard_scaler*16.57143),left_form_edge+int(horizontal_standard_scaler*1.04806):left_form_edge+int(horizontal_standard_scaler*2.17745)])
    info_dict["Business Name/Addr."] = pytesseract.image_to_string(page1[address_top_line+int(vertical_standard_scaler*16.10084):address_top_line+int(vertical_standard_scaler*16.68067),left_form_edge+int(horizontal_standard_scaler*-1.96858):left_form_edge+int(horizontal_standard_scaler*1.03882)])
    
    #Section 3
    info_dict["Date Rehired"] = pytesseract.image_to_string(page1[address_top_line+int(vertical_standard_scaler*17.52941):address_top_line+int(vertical_standard_scaler*18.04202),left_form_edge+int(horizontal_standard_scaler*0.64325):left_form_edge+int(horizontal_standard_scaler*2.48614)])
    info_dict["Reverif. Doc. Type"] = pytesseract.image_to_string(page1[address_top_line+int(vertical_standard_scaler*18.45378):address_top_line+int(vertical_standard_scaler*19.00840),left_form_edge+int(horizontal_standard_scaler*0.27542):left_form_edge+int(horizontal_standard_scaler*0.94085)])
    info_dict["Reverif. Doc. Num."] = pytesseract.image_to_string(page1[address_top_line+int(vertical_standard_scaler*18.45378):address_top_line+int(vertical_standard_scaler*19.00840),left_form_edge+int(horizontal_standard_scaler*0.27542):left_form_edge+int(horizontal_standard_scaler*0.94085)])
    info_dict["Reverif. Doc. Exp."] = pytesseract.image_to_string(page1[address_top_line+int(vertical_standard_scaler*18.45378):address_top_line+int(vertical_standard_scaler*19.00000),left_form_edge+int(horizontal_standard_scaler*1.63031):left_form_edge+int(horizontal_standard_scaler*2.19224)])
