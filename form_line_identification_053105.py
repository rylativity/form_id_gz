...
def process_I9_05_31_05(page):  
    ...
    info_dict["MI"] = pytesseract.image_to_string(page1[address_top_line+int(vertical_standard_scaler*-0.64151):address_top_line+int(vertical_standard_scaler*-0.03774),left_form_edge+int(horizontal_standard_scaler*0.82989):left_form_edge+int(horizontal_standard_scaler*0.99812)])
